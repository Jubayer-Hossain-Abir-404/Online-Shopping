<?php
	...
	function cart(){
		...
		if(isset($_GET['add_cart'])){
            ...
            $ip=get_ip();
            $run_check_product=mysqli_query($conn,"SELECT * FROM cart WHERE product_id='$product_id'");
           ...
           if(mysqli_num_rows($run_check_product) >0){
                ...
                $run_insert_product = mysqli_query($conn, "INSERT INTO cart (product_id,product_name,ip_address,product_quantity) values ('$product_id', '$product_name','$ip','') ");
