                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="home_user1.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cart1.php">Shopping Cart<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <?php 
                                        ...
                                        $check_cart=mysqli_num_rows($run_cart); 
                                        if($check_product==0||$check_cart==0){
                                            echo "<a href='checkout1.php' class='btn btn-primary disabled' role='button' aria-disabled='true'>Checkout</a>
                                                    ";
                                        }
                                        else{
                                            echo "<button class='btn btn-primary'><a href='checkout1.php'>Checkout</a></button>
                                                    "; 
                                        }
                                    ?>
