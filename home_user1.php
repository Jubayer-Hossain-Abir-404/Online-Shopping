                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="home_user1.php">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cart1.php">Shopping Cart</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class='card'>
                                        ...
                                        <div class='card-body'>
                                            ...
                                            <div class='box'>
                                                ...
                                                <a href='home_user1.php?add_cart=$product_id' class='btn btn-danger'>Add to Cart</a>
