                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <?php 
                                        ...
                                        $check_cart=mysqli_num_rows($run_cart); 
                                        if($check_product==0||$check_cart==0){
                                            echo "<a href='checkout.php' class='btn btn-primary disabled' role='button' aria-disabled='true'>Checkout</a>
                                                    ";
                                        }
                                        else{
                                            echo "<button class='btn btn-primary'><a href='checkout.php'>Checkout</a></button>
                                                    ";
                                        }
                                    ?>
